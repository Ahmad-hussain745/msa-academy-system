    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          ...
          <div className="text-lg font-semibold font-mono text-brick">{fmt(summary.total_outstanding)}</div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="text-xs text-slate-500">Students With Arrears</div>
          <div className="text-lg font-semibold font-mono text-ink">{summary.students_with_arrears}</div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="text-xs text-slate-500">1 Month Pending</div>
          <div className="text-lg font-semibold font-mono text-ink">{summary.one_month}</div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="text-xs text-slate-500">2 Months Pending</div>
          <div className="text-lg font-semibold font-mono text-gold">{summary.two_months}</div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="text-xs text-slate-500">3+ Months Pending</div>
          <div className="text-lg font-semibold font-mono text-brick">{summary.three_plus_months}</div>
        </div>
      </div>
