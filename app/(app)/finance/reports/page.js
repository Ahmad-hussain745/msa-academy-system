    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          ...
          <div className="text-lg font-semibold font-mono text-ink">{fmt(studentFeeIncome)}</div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="text-xs text-slate-500">Net</div>
          <div className={`text-lg font-semibold font-mono ${net >= 0 ? "text-sage" : "text-brick"}`}>{fmt(net)}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 mb-2">
        {(accounts || []).map((a) => (
          <div key={a.id} className="bg-white border border-slate-200 rounded-xl p-4">
            ...
            <div className="text-lg font-semibold font-mono text-ink">{fmt(a.current_balance)}</div>
          </div>
        ))}
      </div>
